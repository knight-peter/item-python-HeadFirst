...
Radiobutton(app,variable=depot,text="浙江杭州",value="浙江杭州").pack()
Radiobutton(app,variable=depot,text="浙江绍兴",value="浙江绍兴").pack()
Radiobutton(app,variable=depot,text="山东济南",value="山东济南").pack()
